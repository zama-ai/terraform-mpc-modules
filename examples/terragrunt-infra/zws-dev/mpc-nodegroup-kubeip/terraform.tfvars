# =============================================================================
# MPC Node Group with KubeIP Configuration - zws-dev Development Environment  
# =============================================================================
...
nodegroup_additional_security_group_ids = [
  "sg-04e41735e6bdc6007"
]
...
tags = {
  ...
  # Terragrunt tracking
  TerragruntPath = "examples/terragrunt-infra/zws-dev/mpc-nodegroup-kubeip"
}