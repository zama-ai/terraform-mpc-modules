...
| <a name="input_sync_bucket"></a> [sync\_bucket](#input\_sync\_bucket) | Sync bucket for the MPC service | <pre>object({<br/>    enabled        = optional(bool, true)<br/>    configmap_name = optional(string, "mpc-party")<br/>  })</pre> | <pre>{<br/>  "configmap_name": "mpc-party",<br/>  "enabled": true<br/>}</pre> | no |
